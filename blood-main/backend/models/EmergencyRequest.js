...
const emergencyRequestSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['Waiting', 'Donor Matched', 'Donor Accepted', 'Donor Arriving', 'Verifying', 'Completed', 'Needs Verification', 'Cancelled'], default: 'Waiting' },
  ...
  requester_access_token: { type: String, select: false }
});
